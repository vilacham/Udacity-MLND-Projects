...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon -= 0.05
            # self.epsilon = math.pow(self.alpha, self.auxiliar)
            # self.epsilon = 1 / math.pow(self.auxiliar, 2)
            # self.epsilon = math.exp(-1 * self.alpha * self.auxiliar)
            self.epsilon = math.cos(self.alpha * self.auxiliar)
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if self.epsilon > random.random():
                ...
                best_actions = [action for action, q in self.Q[state].iteritems() if q == maximum]
